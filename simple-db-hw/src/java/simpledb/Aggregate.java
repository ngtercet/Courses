...
public class Aggregate extends Operator {
    ...
    public Aggregate(OpIterator child, int afield, int gfield, Aggregator.Op aop) {
        ...
        String aname = aop.toString() + "(" + childTd.getFieldName(afield) + ")";
        if (gfield != -1) {
            Type[] types = {childTd.getFieldType(gfield), Type.INT_TYPE};
            String[] names = {childTd.getFieldName(gfield), aname};
